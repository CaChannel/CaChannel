...
Py_ca_clear(PyObject *self, PyObject *args){
  ...
  if(!PyArg_ParseTuple(args, "n", &ch_id))
    return NULL;
...
Py_ca_get(PyObject *self, PyObject *args, PyObject *kws){
  ...
  if(!PyArg_ParseTupleAndKeywords(args, kws, "nOlk|i", kwlist, &ch_id, &pcallback, &type, &ecount, &use_numpy))
    return NULL; 
...
static PyObject *Py_ca_put(PyObject *self, PyObject *args)
{
  ...
  pcallback=Py_None;
  myval=Py_None;
  if(!PyArg_ParseTuple(args, "nO|OOh", 
...
Py_ca_monitor(PyObject *self, PyObject *args, PyObject *kws){
  ...
  if(!PyArg_ParseTupleAndKeywords(args, kws, "nOk|kli", kwlist, &ch_id, &pcallback, &ecount, &evmask, &type, &use_numpy))
    return NULL; 
...
Py_sg_put(PyObject *self, PyObject *args){
  ...
  if(!PyArg_ParseTuple(args, "innOl", &gid, &ch_id, &pbuf, &value, &type)){
    return NULL;
  }
...
Py_sg_get(PyObject *self, PyObject *args){
  ...
  if(!PyArg_ParseTuple(args, "inn", &gid, &ch_id, &pbuf)){
    return NULL;
  }
...
Py_ca_convert(PyObject *self, PyObject *args){
  ...
  if(!PyArg_ParseTuple(args, "nn", &ch_id, &pbuf)){
    return NULL;
  }
